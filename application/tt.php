                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                        <input type="password"  class="form-control" name="password" disabled="" placeholder="**********"  />
                          
                          <i>Note: Only the members are allowed to change their password until and unless it's an emergency.</i>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                        <input type="number" value='<?php echo $row['amount']; ?>' name="amount" class="form-control">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                        <input type="number" id="mask-phone" name="contact" value='<?php echo $row['contact']; ?>' class="form-control">
