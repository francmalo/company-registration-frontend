...
<body class="pl-3" style="background:white;">
    <div class="container">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <form class="form-horizontal form-label-top"
                                                                            ...
                                                                            <div class="x_panel">
                                                                                ...
                                                                                <div class="x_content">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="form-group row">
                                                                                            <label
                                                                                                class="control-label col-md-3 col-sm-3 col-xs-3">Mobile
                                                                                                :</label>
                                                                                            <div
                                                                                                class="col-md-9 col-sm-9 col-xs-9">
                                                                                                <input type="number"
                                                                        ...
                                                                        <div class="x_panel">
                                                                            ...
                                                                            <div class="x_content">
                                                                                <div>
                                                                                    <i>The minimum number of names that
                                                                                        you can add is 3 and the maximum
                                                                                        is
                                                                                        5.
                                                                                        Be keen to add the names in the
                                                                                        order of priority since the
                                                                                        registrar
                                                                                        will approve the first available
                                                                                        name. The names may be rejected
                                                                                        if
                                                                                        it
                                                                                        is too close to a name of an
                                                                                        already-registered Kenyan
                                                                                        business.</i>
                                                                                </div>
                                                                                <br />
                                                                        ...
                                                                        <div class="x_panel">
                                                                            ...
                                                                            <div class="x_content">
                                                                                <div>
                                                                                    <i>Please fill in the registered
                                                                                        office addresses.</i>
                                                                                </div>
                                                                                <br />
                                                                                <div class="row">
                                                                        ...
                                                                        <div id="shareholder-director-container">
                                                                            <div class="x_panel">
                                                                                <div class="x_title">
                                                                                    <h2>Shareholder/Director Information
                                                                                    </h2>
                                                                                    <div class="clearfix"></div>
                                                                                </div>
                                                                                <div class="x_content">
                                                                                    <div class="form-group row">
                                                                                        <label
                                                                                            class="control-label col-md-3 col-sm-3 col-xs-3">Person
                                                                                            Type
                                                                                            <span
                                                                                                class="text-danger">*</span>:</label>
                                                                                        <div
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label
                                                                                            class="control-label col-md-3 col-sm-3 col-xs-3">Name
                                                                                            <span
                                                                                                class="text-danger">*</span>:</label>
                                                                                        <div
                                                                                            class="col-md-9 col-sm-9 col-xs-9">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label
                                                                                            class="control-label col-md-3 col-sm-3 col-xs-3">National
                                                                                            ID
                                                                                            <span
                                                                                                class="text-danger">*</span>:</label>
                                                                                        <div
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label
                                                                                            class="control-label col-md-3 col-sm-3 col-xs-3">PIN
                                                                                            Certificate
                                                                                            <span
                                                                                                class="text-danger">*</span>:</label>
                                                                                        <div
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label
                                                                                            class="control-label col-md-3 col-sm-3 col-xs-3">Passport
                                                                                            Photo
                                                                                            <span
                                                                                                class="text-danger">*</span>:</label>
                                                                                        <div
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label
                                                                                            class="control-label col-md-3 col-sm-3 col-xs-3">Residential
                                                                                            Address <span
                                                                                                class="text-danger">*</span>:</label>
                                                                                        <div
                                                                                            class="col-md-9 col-sm-9 col-xs-9">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <div
                                                                                            ...
                                                                                            <button type="button"
                                                                                                class="remove-panel">Remove</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <!-- end of panel -->
                                                                        <button type="button"
                                                                            id="add-shareholder-director">Add
                                                                            Shareholder/Director</button>
        ...
        <script>
        // const shareholderDirectorContainer = document.getElementById('shareholder-director-container');

        // document.getElementById('add-shareholder-director').addEventListener('click', function() {
        //     const panelTemplate = document.createElement('div');
        //     panelTemplate.className = 'x_panel';
        ...
        //                 <div class="radio">
        //                     <label>
        //                         <input type="radio" name="person_type[]" value="shareholder"> Shareholder
        //                     </label>
        //                     <label>
        ...
        //                                             <div class="col-md-9 col-sm-9 col-xs-9">
        //                                                 <input type="number" class="form-control form-control-sm"
        //                                                     name="shares[]" placeholder="" required>
        ...
        //     shareholderDirectorContainer.appendChild(panelTemplate);
        // });

        // shareholderDirectorContainer.addEventListener('click', function(event) {
        ...
        <div class="x_content">
            <div class="form-group row">
                <label class="control-label col-md-3 col-sm-3 col-xs-3">Person Type <span class="text-danger">*</span>:</label>
                <div class="col-md-9 col-sm-9 col-xs-9">
                    <div class="radio">
                        <label>
                            <input type="radio" name="person_type[${panelIndex}][]" value="shareholder"> Shareholder
                        </label>
                        <label>
                            <input type="radio" name="person_type[${panelIndex}][]" value="director"> Director
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <label class="control-label col-md-3 col-sm-3 col-xs-3">Name <span class="text-danger">*</span>:</label>
                <div class="col-md-9 col-sm-9 col-xs-9">
                    <input type="text" class="form-control form-control-sm" name="name[${panelIndex}][]" placeholder="" required>
                </div>
            </div>
            <!-- Rest of the form fields -->
            <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
                    <input type="text" class="form-control form-control-sm" name="postal_address[${panelIndex}][]" placeholder="" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="control-label col-md-3 col-sm-3 col-xs-3">National ID <span class="text-danger">*</span>:</label>
                <div class="col-md-9 col-sm-9 col-xs-9">
                    <input type="file" class="form-control form-control-sm" name="national_id[${panelIndex}][]" accept="image/*,application/pdf" required>
